(()=>{
const ID='__acl644', KEY='__acl691cache';
...
async function ocrCapturedImage(dataUrl){
 ...
 try{
   ...
   if(ok){OCR_PIN=true;draw(true);setMsg(`${label} OCR 完成 ✓ 已加入 summary，可直接 Copy。`)}
